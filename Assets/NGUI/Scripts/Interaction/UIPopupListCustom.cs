...
[ExecuteInEditMode]
[AddComponentMenu("NGUI/Interaction/Popup List Custom")]
public class UIPopupListCustom : UIWidgetContainer
{
	/// <summary>
	/// Current popup list. Only available during the OnSelectionChange event callback.
	/// </summary>

	static public UIPopupListCustom current;
	...
	[System.Obsolete("Use EventDelegate.Add(popup.onChange, YourCallback) instead, and UIPopupListCustom.current.value to determine the state")]
	...
	protected virtual Vector3 GetHighlightPosition ()
	{
		...
		float offsetX = border.x * scaleFactor + PaddingSize;
