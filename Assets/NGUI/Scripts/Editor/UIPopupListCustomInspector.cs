...
/// <summary>
/// Inspector class used to edit UIPopupListCustom.
/// </summary>

[CustomEditor(typeof(UIPopupListCustom), true)]
public class UIPopupListCustomInspector : UIWidgetContainerEditor
{
	enum FontType
	{
		Bitmap,
